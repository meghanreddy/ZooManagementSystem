...
$count_today_visitors=$result['totaladult'];
 ?>  
                                       ...
                                       <p style="font-size: 20px;color: red">68</p>
                                    </div>
                                </div>
...
$count_today_cvisitors=$result['totalchild'];
 ?>  
                                        ...
                                        <p style="font-size: 20px;color: red">182</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$count_Yest_visitors=$result['totaladulty'];
 ?>
                                        ...
                                        <p style="font-size: 20px;color: red">93</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$count_Yest_cvisitors=$result['totalchildy'];
 ?>
                                        ...
                                        <p style="font-size: 20px;color: red">243</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$count_today_visitors=$result['totaladult'];
 ?>  
                                       ...
                                       <p style="font-size: 20px;color: red">23</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$count_today_cvisitors=$result['totalchild'];
 ?>  
                                        ...
                                        <p style="font-size: 20px;color: red">11</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$count_Yest_visitors=$result['totaladulty'];
 ?>
                                        ...
                                        <p style="font-size: 20px;color: red">19</p>
                                    </div>
                                </div>
